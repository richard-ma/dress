...
class CscartActionTestCase(unittest.TestCase):
    ...
    def test_cscart_order_start_id(self):
        ...
        self.assertEqual(1, len(data))
        self.assertTrue(
            "mysql -u root -p'target_database_root_password' -e \"UPDATE \`target_database_name\`.\`table_prefix_settings_objects\` SET \`value\` = 'order_start_id' WHERE \`table_prefix_settings_objects\`.\`object_id\` = 62;\""
            in data[0])

    def test_cscart_order_start_id_is_none(self):
        action = CscartOrderStartIdAction(
            target_database_root_password='target_database_root_password',
            target_database_name='target_database_name',
            table_prefix='table_prefix_',
    ...
    def test_cscart_smtp_setting_smtp_host_is_none(self):
        action = CscartSmtpSettingAction(
            target_database_root_password='target_database_root_password',
            target_database_name='target_database_name',
            table_prefix='table_prefix_',
    ...
    def test_cscart_smtp_setting_smtp_user_name_is_none(self):
        action = CscartSmtpSettingAction(
            target_database_root_password='target_database_root_password',
            target_database_name='target_database_name',
            table_prefix='table_prefix_',
    ...
    def test_cscart_smtp_setting_user_password_is_none(self):
        action = CscartSmtpSettingAction(
            target_database_root_password='target_database_root_password',
            target_database_name='target_database_name',
            table_prefix='table_prefix_',
