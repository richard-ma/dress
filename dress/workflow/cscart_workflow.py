...
def cscart_workflow(**params):
    ...
    ).push(CopySiteAction(**parsed_params)
    ).push(ApacheConfigAction(**parsed_params)
    ).push(NginxConfigAction(**parsed_params)
    ).push(MysqlCreateUserAction(**parsed_params)
    ).push(MysqlCreateDatabaseAction(**parsed_params)
    ).push(MysqlImportDataAction(**parsed_params)
    ).push(CscartClearCacheAction(**parsed_params)
    ).push(CscartConfigAction(**parsed_params)
